		...
		<div class="wrap">
			<div class="options">
				...
				<table class="form-table">
					<tr valign="top">
						<th scope="row"><label><?php _e("Speed:", 'sponsors-carousel'); ?></label></th>
						<td>
							<input type="text" size="10" name="scwp_animation_speed" id="scwp_animation_speed" value="<?php echo stripslashes(get_option('scwp_animation_speed')) ?>" /><br>
							<em>Options: 'fast', 'slow', or a number value. 0 is instant, 10000 is very slow.</em>
						</td>
					</tr>
					<tr valign="top">
						<th><label><?php _e("Show Titles:", 'sponsors-carousel'); ?></label></th>
						<td>
							<label><?php
							...
							echo " />";
							?>
							<?php _e("Yes, show image titles.", 'sponsors-carousel'); ?></label><br>
							<label>
							<?php
							echo "<input type='radio' ";
							echo "name='scwp_show_titles' ";
							...
							<em>Should the title of each image be shown?</em>
						</td>
					</tr>
					<tr valign="top">
						<th><?php _e("Scroll Amount:", 'sponsors-carousel'); ?></th>
						<td>
							<input type="text" size="10" name="scwp_scroll_amount" id="scwp_scroll_amount" value="<?php echo stripslashes(get_option('scwp_scroll_amount')) ?>" /><br>
							<em>How many items should the carousel scroll?</em>
						</td>
					</tr>

			<?php // Output new option field for scrolling speed ?>
					
					<tr valign="top">
						<th><?php _e("Auto scroll:", 'sponsors-carousel'); ?></th>
 						<td>
							...
							<em>Select the auto scrolling speed.</em>
						</td>
					</tr>

			<?php // Output new option field for link target ?>
					
					<tr valign="top">
						<th><?php _e("Link target:", 'sponsors-carousel'); ?></th>
						<td>
							...
							<em>Choose whether the links should open in the current window.</em>
						</td>
					</tr>	
					<tr valign="top">
						<th><?php _e("Default link:", 'sponsors-carousel'); ?></th>
						<td>
							<input type="text" size="50" name="scwp_default_link" id="scwp_default_link" value="<?php echo stripslashes(get_option('scwp_default_link')) ?>" /><br>
							<em>Link to sponsors page. You can add custom link in image caption.</em>
						</td>
					</tr>
					<tr valign="top">
						<th><?php _e("New (select *full size* before insert): ", 'sponsors-carousel'); ?></th>
						<td>
					...
					<tr valign="top">
						...
						<th>
							<label class="submit">
								...
								<input type='submit' name='info_update' value="<?php _e('Save Changes', 'sponsors-carousel'); ?>" class="button" />
								</form>
							</label>
						</th>
					</tr>
